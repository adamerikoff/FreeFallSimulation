...
pub fn make_triangle(device: &wgpu::Device) -> wgpu::Buffer {
    let vertices: [Vertex; 3] = [
        Vertex {position: Vec3::new(-0.99, -0.75, 0.0), color: Vec3::new(1.0, 0.0, 0.0)},
...
pub fn make_quad(device: &wgpu::Device) -> Mesh {
    let vertices: [Vertex; 4] = [
        Vertex {
            position: Vec3::new(-0.5, -0.5, 0.0), // Bottom-left (1st triangle)
            color: Vec3::new(1.0, 0.0, 0.0),
        },
        Vertex {
            position: Vec3::new(0.5, -0.5, 0.0), // Bottom-right (1st triangle)
            color: Vec3::new(0.0, 1.0, 0.0),
        },
        Vertex {
            position: Vec3::new(0.5, 0.5, 0.0),  // Top-right (1st triangle)
            color: Vec3::new(0.0, 0.0, 1.0),
        },
        Vertex {
            position: Vec3::new(-0.5, 0.5, 0.0), // Top-left (2nd triangle)
